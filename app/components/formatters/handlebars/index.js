...
export const PkmList = Loadable({
  loader: () => import(/* webpackChunkName: "formatters/handlebars" */ './components').then(e => e.PkmList),
  loading: Loading
});
export const FormattingOptions = Loadable({
  loader: () => import(/* webpackChunkName: "formatters/handlebars" */ './components').then(e => e.FormattingOptions),
  loading: Loading
});
